...
5. natsumi の返事のうち、まだ確かめていないものが、キャラクターの上の白い吹き出しに古い順に重なって出ます。
   ...
   - × で、残りの返事をすべて確かめて閉じます。最後の 1 件を確かめると吹き出しは閉じます。内容は履歴で見られます。
...
6. natsumi からの知らせは、返事とは別に、キャラクターの横の黄色い束に出ます。キャラクターの右上には、確かめていない知らせの件数の黄色い印が付きます。
   - 前に出ている知らせの本文をクリックすると確かめたことになり、印の件数が減ります。
...
8. キャラクターの右クリックのメニューには、話しかける・履歴を開く・設定…・ログアウト・終了があります。メニューバーのアイコンにも同じ項目があります。
...
吹き出し・知らせの束・入力欄は、キャラクターと一緒に動き、互いに重ならないように置かれ、画面の端では入る側に回ります。
