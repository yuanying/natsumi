...
UI テスト `NatsumiPhoneUITests` は、この偽のサーバーを相手にログインから返事までを辿り、画面を撮ります
（偽のサーバーを先に起動してください）。撮った画面は結果の bundle に添付され、`TEST_RUNNER_NATSUMI_SCREENSHOTS` に
