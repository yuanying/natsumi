...
- 済んだ返事に画像の成果物（A2A の FilePart）があれば、サーバーが取り込みます（[ADR 0048](docs/adr/0048-bringing-in-images-an-agent-hands-back.md)）。
  ...
  1 枚 10 MiB・1 回 8 枚までを、作業環境の `/work/agents/<名前>/<日時>-<名前>` に置き、`.natsumi/images/` にも写しを残します（migration 18）。
