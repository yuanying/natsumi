...
- Date: 2026-09-14
- Status: Accepted（思考ループに登録するツールは [ADR 0008](0008-single-thinking-loop-and-mac-conversation.md) で置き換え、記憶のツールは [ADR 0009](0009-long-term-memory-and-nightly-session-switch.md) で追加）
