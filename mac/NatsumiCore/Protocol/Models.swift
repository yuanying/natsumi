...
public struct Snapshot: Equatable, Sendable {
    ...
    public init(deviceId: String, messages: [ShownMessage], pendingEvents: [PendingEvent], expression: Expression) {
...
/// `command.accepted`: a recorded `conversation.send`, or a `session.sync` that replayed what was missed.
public struct CommandAccepted: Codable, Equatable, Sendable {
    ...
    public init(messageId: String? = nil, eventId: String? = nil, state: EventState? = nil, deviceId: String? = nil, mode: String? = nil) {
        self.messageId = messageId
        self.eventId = eventId
        self.state = state
        self.deviceId = deviceId
